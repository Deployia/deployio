...
class UnifiedDetectionEngine:
    ...
    async def analyze_repository(
        ...
        try:
            ...
            if (combined_result.confidence_score < self.llm_enhancement_threshold or force_llm):
    ...
    async def _perform_parallel_analysis(
        ...
        if AnalysisType.DEPENDENCY_ANALYSIS in analysis_types:
            tasks[AnalysisType.DEPENDENCY_ANALYSIS] = self.dependency_analyzer.analyze(repo_data)
    ...
    async def _combine_analysis_results(
        ...
        overall_confidence = calculate_weighted_confidence(confidence_scores, confidence_weights)
    ...
    async def health_check(self) -> Dict[str, str]:
        ...
        health_status = {
            ...
            "llm_enhancer": "healthy" if self.llm_enhancer.is_available() else "unavailable",
