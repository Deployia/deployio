...
from .models import (
    LLMRequest, LLMResponse, LLMProvider, LLMClientConfig,
    LLMError, LLMRateLimitError, LLMQuotaExceededError
)
...
class LLMClientManager:
    ...
    def _load_config_from_env(self) -> LLMClientConfig:
        ...
        return LLMClientConfig(
            ...
            preferred_provider=LLMProvider(os.getenv("LLM_PREFERRED_PROVIDER", "openai")),
            fallback_providers=[
                LLMProvider.GROQ,
                LLMProvider.OPENAI
            ]
    ...
    async def initialize(self) -> bool:
        ...
        try:
            ...
            logger.info(f"LLM Client Manager initialized with providers: {available_providers}")
    ...
    def get_available_providers(self) -> List[LLMProvider]:
        ...
        return [
            provider for provider, client in self.clients.items()
            if client.is_available
        ]
    
    def get_client(self, provider: Optional[LLMProvider] = None) -> Optional[BaseLLMClient]:
        """
    ...
    async def health_check(self) -> Dict[str, Any]:
        ...
        health_status["overall_status"] = "healthy" if available_count > 0 else "unhealthy"
