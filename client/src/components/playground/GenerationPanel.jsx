    ...
    <div className="h-full w-full flex flex-col bg-neutral-900">
      ...
      <div className="p-3 md:p-6 border-b border-neutral-800/50 flex-shrink-0 w-full">
        <div className="flex items-center gap-2 md:gap-3 mb-3 md:mb-4">
          <FiZap className="w-5 h-5 md:w-6 md:h-6 text-yellow-400" />
          <div>
      ...
      >
        <div className="max-w-8xl mx-auto px-2 sm:px-3 md:px-6 py-4 md:py-10 w-full h-full flex flex-col">
          {/* Generate Button */}
          <div className="mb-6 md:mb-10">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 md:gap-4">
              <div>
                <h3 className="text-base md:text-lg font-semibold text-white heading mb-1">
                  {activeGenerator
                    .split("-")
              ...
              <motion.button
                ...
                className="flex items-center gap-2 px-4 py-2 md:px-6 md:py-3 bg-yellow-500/20 border border-yellow-500/30 rounded-lg text-yellow-400 hover:bg-yellow-500/30 transition-colors disabled:opacity-50 body text-sm md:text-base"
              >
                {isGenerating ? (
                  <>
          ...
          >
            {generatedContent ? (
              <>
                {/* Code Header */}
                <div className="flex items-center justify-between px-3 md:px-4 py-2 md:py-3 border-b border-neutral-800/50 flex-shrink-0">
                  <div className="flex items-center gap-2">
                    <FiCheck className="w-3 h-3 md:w-4 md:h-4 text-green-400" />
                  ...
                  <div className="flex items-center gap-1 md:gap-2">
                    ...
                    >
                      {copySuccess ? (
                        <FiCheck className="w-3 h-3 md:w-3.5 md:h-3.5 text-green-400" />
                      ) : (
                        <FiCopy className="w-3 h-3 md:w-3.5 md:h-3.5" />
                      )}
                    </motion.button>
                ...
                {/* Code Content */}
                <div
                  className="w-full flex-1 overflow-auto px-2 md:px-4 py-2 md:py-3"
                  style={{
                    minHeight: "300px",
                    maxHeight: "50vh",
                    scrollbarWidth: "thin",
              ...
              <div className="flex-1 flex items-center justify-center p-4 md:p-8 w-full">
                <div className="text-center max-w-md">
                  <FiCode className="w-12 h-12 md:w-16 md:h-16 text-neutral-600 mx-auto mb-3 md:mb-4" />
                  <h3 className="text-base md:text-lg font-semibold text-white mb-2 heading">
                    Ready to Generate
                  </h3>
                  <p className="text-xs md:text-sm text-neutral-400 body mb-4 md:mb-6">
                    Configure your generation settings in the sidebar and click
                    &quot;Generate&quot; to create optimized deployment files.
                  </p>
                  <div className="grid grid-cols-2 gap-2 md:gap-4 text-xs">
                    <div className="bg-neutral-800/50 rounded-lg p-2 md:p-3">
                      <FiSettings className="w-3 h-3 md:w-4 md:h-4 text-blue-400 mb-1 md:mb-2" />
                      <div className="text-neutral-300 font-medium mb-1 text-xs">
                        Customizable
                      </div>
                    ...
                    <div className="bg-neutral-800/50 rounded-lg p-2 md:p-3">
                      <FiZap className="w-3 h-3 md:w-4 md:h-4 text-yellow-400 mb-1 md:mb-2" />
                      <div className="text-neutral-300 font-medium mb-1 text-xs">
                        AI-Powered
                      </div>
                      <div className="text-neutral-500 text-xs">
