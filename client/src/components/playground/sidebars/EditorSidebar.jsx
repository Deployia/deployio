import { FaCode, FaBookOpen, FaLock, FaUnlock } from "react-icons/fa";
  ...
  return (
    ...
    >
      <div className="p-4 space-y-4 min-h-full">
        {/* Ensure full height for proper scrolling */}
        ...
        {workspace.activeFile ? (
          <div className="space-y-4">
            ...
            <div className="bg-neutral-900/50 backdrop-blur-md border border-neutral-800/50 rounded-xl p-4">
              ...
              <div className="text-xs text-neutral-300 body leading-relaxed">
                This file contains DevOps best practices and configurations. Ask
                DeployBot about the structure and patterns used in modern
                deployments.
              </div>
            </div>
          ...
          <div className="text-center py-12">
            ...
            <div className="text-xs text-neutral-500 body">
              Select a file from the explorer to get DeployBot insights and code
              analysis
            </div>
          </div>
        )}
