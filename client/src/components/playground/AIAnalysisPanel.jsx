              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-white font-semibold">
                      {mockAnalysisData.overview.score}%
                    </span>
                  </div>
                </div>
                <div className="flex justify-between">
                  ...
                  <span className="text-white body">
                    {mockAnalysisData.overview.language}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-300 body">Framework</span>
                  <span className="text-white body">
                    {mockAnalysisData.overview.framework}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span className="text-neutral-300 body">Dependencies</span>
                  <span className="text-white body">
                    {mockAnalysisData.overview.dependencies}
                  </span>
                </div>
              </div>
            </div>
              ...
              <div className="space-y-4">
                <div className="flex items-center gap-2 mb-2">
                  ...
                  <span className="text-sm font-medium text-yellow-400 body">
                    {mockAnalysisData.security.vulnerabilities} vulnerabilities
                    found
                  </span>
                </div>
                <div className="space-y-2">
                  {mockAnalysisData.security.recommendations.map(
                    (rec, index) => (
                      <div
                        key={index}
          ...
          <div className="space-y-6">
            <div className="bg-neutral-900/50 backdrop-blur-md border border-neutral-800/50 rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  {mockAnalysisData.performance.recommendations.map(
                    (rec, index) => (
                      <div
                        key={index}
                        className="flex items-center gap-2 p-2 bg-neutral-800/50 rounded"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="text-center p-4 bg-neutral-800/50 rounded-lg">
                  <div className="text-2xl font-bold text-white heading">
                    {mockAnalysisData.quality.score}%
                  </div>
                  <div className="text-sm text-neutral-400 body">
                    Overall Score
                  </div>
                ...
                <div className="text-center p-4 bg-neutral-800/50 rounded-lg">
                  <div className="text-2xl font-bold text-white heading">
                    {mockAnalysisData.quality.coverage}%
                  </div>
                  <div className="text-sm text-neutral-400 body">
                    Test Coverage
                  </div>
                ...
                <div className="text-center p-4 bg-neutral-800/50 rounded-lg">
                  <div className="text-sm font-medium text-white heading">
                    {mockAnalysisData.quality.complexity}
                  </div>
                  <div className="text-sm text-neutral-400 body">
                    Complexity
                  </div>
                ...
                <div className="text-center p-4 bg-neutral-800/50 rounded-lg">
                  <div className="text-sm font-medium text-white heading">
                    {mockAnalysisData.quality.maintainability}
                  </div>
                  <div className="text-sm text-neutral-400 body">
                    Maintainability
                  </div>
