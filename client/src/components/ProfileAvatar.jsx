    ...
    return (
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.95 }}
          className="flex items-center gap-2 px-2 py-2 rounded-lg hover:bg-neutral-800/50 transition-all duration-200 border border-transparent hover:border-neutral-700 relative"
        >
          <div className="relative">
            ...
            {user?.role === "admin" && (
              <motion.div
                ...
                title="Admin User"
              >
                <FaShieldAlt className="w-2 h-2 text-white" />
              </motion.div>
            )}
          </div>
          <motion.div
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      {user?.role === "admin" && (
                        <motion.div
                          ...
                          className="px-2 py-1 text-xs font-medium text-red-300 bg-red-500/20 border border-red-500/30 rounded-md"
                        >
                          Admin
                        </motion.div>
                      )}
