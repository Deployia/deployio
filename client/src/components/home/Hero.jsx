    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-6 pb-2">
        ...
        <motion.div
          ...
          className="inline-flex items-center mb-6 px-4 py-2 bg-gradient-to-r from-blue-500/10 to-purple-500/10 backdrop-blur-sm border border-blue-500/20 rounded-full text-sm font-medium text-blue-400 hover:from-blue-500/20 hover:to-purple-500/20 transition-all duration-300"
        >
