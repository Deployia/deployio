      ...
      <div className="text-center mb-6 sm:mb-8">
        ...
        >
          ...
          <p className="text-sm sm:text-base text-neutral-400 max-w-2xl mx-auto px-2">
            Review your project configuration and deploy. Your project will be
            created and made ready for deployment with the settings shown below.
          </p>
        </motion.div>
      </div>
          ...
          <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 sm:gap-0">
            <div className="flex items-center space-x-3">
              <div className="w-8 h-8 sm:w-10 sm:h-10 bg-blue-500/20 rounded-full flex items-center justify-center">
                <FaCheckCircle className="w-4 h-4 sm:w-5 sm:h-5 text-blue-400" />
              </div>
              <div>
                <h3 className="text-blue-400 font-medium">
                  AI Configuration Confidence
                </h3>
        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-2">
            ...
            <div>
              ...
              <p className="text-white font-medium">
                {stepData.deploymentSettings?.port}
              </p>
            </div>
            ...
            >
              ...
              <div className="space-y-2">
                {stepData.environmentVariables.map((env, index) => (
                  <div
                    key={index}
                    className="flex items-center justify-between p-2 bg-neutral-900/30 rounded"
                  >
                    <div className="flex items-center space-x-3">
