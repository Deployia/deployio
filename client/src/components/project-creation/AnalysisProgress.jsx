...
const AnalysisProgress = ({ stepData, onNext, loading }) => {
  const dispatch = useDispatch();
  const [analysisLogs, setAnalysisLogs] = useState([]);

  // Start analysis when component mounts
  useEffect(() => {
    if (!stepData.analysisId && stepData.selectedRepository && stepData.selectedBranch) {
  ...
  }, [dispatch, stepData.analysisStatus, stepData.analysisId, stepData.analysisProgress]);
    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="text-center mb-8">
        ...
        >
          ...
          <p className={`max-w-2xl mx-auto ${getStatusColor(stepData.analysisStatus)}`}>
        ...
        >
          ...
          <div className="grid gap-4 md:grid-cols-3">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-green-300">Dependencies Analyzed</div>
            </div>
            <div className="text-center">
              <div className="text-2xl font-bold text-white">
