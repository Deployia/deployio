    ...
    <section className="py-4 sm:py-8 lg:py-12 px-4 sm:px-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="flex justify-center mb-6 sm:mb-8">
          <div className="flex flex-col sm:flex-row bg-gray-800/50 backdrop-blur-lg border border-gray-700/50 rounded-xl p-2 w-full sm:w-auto">
            {platforms.map((platform) => (
              <button
                key={platform.id}
                onClick={() => onPlatformChange(platform.id)}
                className={`flex items-center justify-center sm:justify-start space-x-2 px-3 sm:px-4 py-2 sm:py-3 rounded-lg transition-all duration-300 ${
        ...
        <div className="grid lg:grid-cols-2 gap-4 sm:gap-6">
          ...
          <motion.div
            ...
            className="bg-gray-800/30 backdrop-blur-lg border border-gray-700/50 rounded-xl p-3 sm:p-4 lg:p-6"
          >
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4 flex items-center">
              <FaDownload className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-green-400" />
              Direct Download
            </h3>
          ...
          >
            <h3 className="text-lg sm:text-xl font-bold text-white mb-3 sm:mb-4 flex items-center">
              <FaCopy className="w-4 h-4 sm:w-5 sm:h-5 mr-2 text-cyan-400" />
              Package Managers
            </h3>{" "}
