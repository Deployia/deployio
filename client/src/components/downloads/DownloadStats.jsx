      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8">
          {stats.map((stat, index) => (
            ...
            >
              <div className="bg-gray-800/40 backdrop-blur-lg border border-gray-700/50 rounded-2xl p-8 hover:border-white/30 transition-all duration-300">
                {stat.icon && (
                  <div
                    className={`p-4 bg-gradient-to-r ${gradient}/20 rounded-xl inline-block mb-4`}
                  >
                ...
                <div
                  className={`text-3xl font-bold mb-2 text-transparent bg-gradient-to-r ${gradient} bg-clip-text`}
                >
                  {stat.value}
                </div>
