...
const OAuthSection = () => {
  ...
  return (
    <div className="grid grid-cols-3 gap-2 sm:gap-3">
      ...
      <OAuthButton provider="github" href={getOAuthUrl("github")}>
        <svg className="w-5 h-5 sm:w-4 sm:h-4" viewBox="0 0 24 24">
          <path
            fill="#fff"
      ...
      <OAuthButton provider="facebook" href={getOAuthUrl("facebook")}>
        <svg className="w-5 h-5 sm:w-4 sm:h-4" viewBox="0 0 24 24">
          <path
            fill="#1877F3"
