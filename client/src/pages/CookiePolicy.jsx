          ...
          >
            ...
            <div className="space-y-4 text-neutral-300 body">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  <strong>Load Balancing Cookies:</strong> Ensure you connect to
                  the same server
                </li>
              </ul>
          ...
          >
            ...
            <div className="space-y-4 text-neutral-300 body">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  <strong>Accessibility Cookies:</strong> Remember accessibility
                  settings
                </li>
              </ul>
            </div>
          ...
          >
            ...
            <div className="space-y-4 text-neutral-300 body">
              ...
              <ul className="list-disc list-inside space-y-2 ml-4">
                ...
                <li>
                  <strong>Performance Analytics:</strong> Monitor website speed
                  and performance
                </li>
                <li>
              ...
              <p className="mt-4">
                ...
                experience. All analytics data is anonymized and cannot be used
