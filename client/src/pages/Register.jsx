...
function Register() {
  ...
  return (
    <div className="min-h-[90vh] bg-black flex items-center justify-center  px-2 sm:px-6 lg:px-8">
      <div className="w-4xl flex flex-row bg-neutral-900 rounded-2xl overflow-hidden border border-neutral-700">
