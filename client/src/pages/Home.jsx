  ...
  return (
    <div className="h-full  overflow-hidden body relative">
      <div
        ...
        style={{
          backgroundImage: `
            repeating-linear-gradient(0deg, transparent, transparent 39px, #BDC0C2 39px, #BDC0C2 40px),
            repeating-linear-gradient(90deg, transparent, transparent 39px, #BDC0C2 39px, #BDC0C2 40px)
          `,
          backgroundSize: "40px 40px",
          backgroundColor: "#000",
          maskImage:
            "linear-gradient(to top, rgba(0,0,0,0.18) 0%, rgba(0,0,0,0.10) 40%, rgba(0,0,0,0.01) 100%)",
          WebkitMaskImage:
            "linear-gradient(to top, rgba(0,0,0,0.18) 0%, rgba(0,0,0,0.10) 40%, rgba(0,0,0,0.01) 100%)",
        }}
      />
      <div className="h-full flex flex-col px-6 py-4 relative z-10">
        ...
        <div className="text-center mb-4 flex-shrink-0">
          ...
          <p className="text-base text-neutral-400 max-w-2xl mx-auto leading-relaxed body">
        ...
        <div className="grid md:grid-cols-3 gap-4 mb-4 max-w-4xl mx-auto flex-shrink-0 body">
          <div className="p-4 backdrop-blur-lg rounded-xl border border-neutral-700 body">
            <div className="w-10 h-10 bg-neutral-800 rounded-lg flex items-center justify-center mb-3 border border-neutral-700">
              <svg
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center mb-6 flex-shrink-0 body">
          <button
            className="bg-neutral-900 text-white border border-neutral-700 px-5 py-2.5 rounded-lg font-semibold text-sm hover:bg-neutral-800 hover:border-white transition-all duration-200 body"
          ...
          {user ? (
            ...
            <div className="space-y-4 body">
              ...
              <div className="flex flex-col sm:flex-row gap-3 justify-center body">
                ...
                <Link
                  to="/auth/login"
                  className="inline-flex items-center justify-center px-6 py-3 bg-neutral-800 text-white border border-neutral-700 font-semibold rounded-lg hover:bg-neutral-700 hover:border-white transition-all duration-200 transform hover:scale-105 body"
                >
                  Sign In
                </Link>
              </div>
