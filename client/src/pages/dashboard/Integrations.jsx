  ...
  const gitProviders = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: getProviderIcon("bitbucket"),
        category: "scm",
        enabled: false,
        popular: false,
        comingSoon: true,
  ...
  const cloudProviders = useMemo(
    () => [
      ...
      },
      {
        ...
        icon: getProviderIcon("azure-cloud"),
        category: "cloud",
        enabled: false,
        popular: false,
        comingSoon: true,
      ...
      },
      {
        ...
        icon: getProviderIcon("digitalocean"),
        category: "cloud",
        enabled: false,
        popular: false,
        comingSoon: true,
